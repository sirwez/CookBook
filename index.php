			...
			<section class="py-5 text-center container">
				<div class="row py-lg-5">
					<div class="col-lg-6 col-md-8 mx-auto">
						...
						<p class="lead text-muted">Receitas para alegrar seu dia.</p>
              <a href="#register" class="card" class="a" text-decoration: none> Quer registrar uma receita? Clique aqui.</a>
					</div>
				</div>
			</section>
